...
class SimulateMethylatedReads:
    ...
    def process_read_group(self, sim_data, stranded_capture=False):
        ...
        # in silico bisulfite conversion, with bisulfite conversion rate
        ...
        if self.undirectional and self.random_roll(0.5):
    ...
    def set_read_methylation(self, read, sub_base='C'):
        ...
        for site in methyl_base_info.split(','):
            ...
            if cigar_base == 'M':
                ...
                # handle methylatable conversions to converted base ie c to t, or g to a
                if seq_base != sub_base:
                    if seq_base == 'T' and sub_base == 'C':
                        methyl_cigar[seq_pos] = 'V'
                    elif seq_base == 'A' and sub_base == 'G':
                        methyl_cigar[seq_pos] = 'V'
                    continue
