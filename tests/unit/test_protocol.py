...
from tests.helpers.stream_support import ProtocolWriter, encode_stream, read_stream
from bsreadsim.htsim.protocol import crc32c
...
class ProtocolCorruptionTests(unittest.TestCase):
    ...
    def test_truncation_and_trailing_bytes_never_succeed(self) -> None:
        self.assert_rejected(frozen_fixture("truncated-stream"), "truncated")
