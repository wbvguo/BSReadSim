...
from bsreadsim.core_process import CoreProcess, CoreProcessError  # noqa: E402
...
BATCH = FragmentBatch(
    ...
    contig_indices=(0,),
    reference_begins=(100,),
    reference_ends=(104,),
    template_offsets=(0, 4),
    mate_offsets=(0, 1),
    site_offsets=(0, 1),
    mate_template_begins=(0,),
    ...
    site_sources=(MethylationSource.CGMAP,),
...
class CoreProcessSuccessTests(unittest.TestCase):
    def test_batches_require_trailer_eof_exit_and_retain_payload(self) -> None:
        ...
        with core as running:
            ...
            self.assertEqual(running.protocol_version, (2, 0))
        ...
        with self.assertRaises(ConsumerFailure):
            with core as running:
                for _batch in running.iter_batches():
                    raise ConsumerFailure("post-processing failed")
