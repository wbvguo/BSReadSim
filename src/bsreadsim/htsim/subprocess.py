"""Supervise the private C++ core process.
...
def _optional_positive_timeout(name: str, value: float | None) -> float | None:
    if value is None:
        return None
...
class CoreProcess:
    ...
    def __init__(
        ...
        *,
        ...
        protocol_idle_timeout_seconds: float | None = None,
        ...
        self._stdout_transport = None  # type: _BoundedStdoutTransport | None
        self._stderr_collector = None  # type: _StderrTailCollector | None
        self._reader = None  # type: ProtocolReader | None
        self._returncode = None  # type: int | None
        self._kill_used = False
        self._cleanup_issue = None  # type: str | None
