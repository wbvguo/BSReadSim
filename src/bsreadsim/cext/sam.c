...
{
    return (uint16_t)(
        (uint16_t)value[0] | (uint16_t)((uint16_t)value[1] << 8)
    );
}
...
PyObject *
bsreadsim_cext_format_sam_batch(PyObject *self, PyObject *args)
{
...
PyObject *
bsreadsim_cext_format_sam_columns(PyObject *self, PyObject *args)
{
