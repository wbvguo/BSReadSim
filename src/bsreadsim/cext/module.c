...
static PyObject *
cext_u64(PyObject *self, PyObject *args)
{
...
static PyObject *
cext_bernoulli(PyObject *self, PyObject *args)
{
    unsigned long long key;
    unsigned long long entity_ordinal;
    unsigned long long local_index;
...
static PyObject *
cext_philox_pairs(PyObject *self, PyObject *args)
{
    unsigned long long key;
...
static PyObject *
cext_apply_uniform_errors(PyObject *self, PyObject *args)
{
    Py_buffer input;
    unsigned long long key;
    unsigned long long entity_ordinal;
...
static PyObject *
cext_crc32c(PyObject *self, PyObject *args)
{
    Py_buffer buffer;
    uint32_t value;
...
get_required_attribute(PyObject *owner, const char *name)
{
    ...
    if (value == NULL) {
        PyErr_Format(
            PyExc_RuntimeError,
            "C extension could not resolve bsreadsim.process.batch.%s",
            name
        );
    }
    return value;
...
checked_add_size(Py_ssize_t *total, Py_ssize_t amount, const char *name)
{
    if (amount < 0 || *total > PY_SSIZE_T_MAX - amount) {
        PyErr_Format(PyExc_OverflowError, "%s exceeds the C-extension buffer limit", name);
        return 0;
    }
    *total += amount;
    return 1;
...
checked_buffer_size(Py_ssize_t count, Py_ssize_t width, Py_ssize_t *result)
{
    if (count < 0 || width < 0 || (width != 0 && count > PY_SSIZE_T_MAX / width)) {
        PyErr_SetString(PyExc_OverflowError, "batch exceeds the C-extension buffer limit");
        return 0;
    }
    *result = count * width;
    return 1;
...
static PyObject *
cext_format_fastq_batch(PyObject *self, PyObject *args)
{
    ...
    if (
        ...
        PyErr_SetString(PyExc_SystemError, "C-extension FASTQ size accounting failed");
        goto done;
    }
...
static PyObject *
cext_sample_bernoulli_sites(PyObject *self, PyObject *args)
{
    PyObject *sites;
    unsigned long long key;
    unsigned long long entity_ordinal;
...
static PyMethodDef cext_methods[] = {
    ...
    },
    {
        ...
        bsreadsim_cext_validate_protocol_batch_columns,
        METH_VARARGS,
        PyDoc_STR(
    ...
    },
    {
        ...
        bsreadsim_cext_pack_protocol_common_columns,
        METH_VARARGS,
        PyDoc_STR(
    ...
    },
    {
        ...
        bsreadsim_cext_decode_protocol_fragments,
        METH_VARARGS,
        PyDoc_STR(
    ...
    {
        "format_sam_columns",
        bsreadsim_cext_format_sam_columns,
        METH_VARARGS,
        PyDoc_STR(
    ...
    {
        "format_sam_batch",
        bsreadsim_cext_format_sam_batch,
        METH_VARARGS,
        PyDoc_STR(
...
static struct PyModuleDef cext_module = {
    ...
    "_cext",
    "Private C-extension operations for BSReadSim.",
    -1,
    cext_methods,
    NULL,
    NULL,
