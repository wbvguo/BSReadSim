...
## Input file format
1. reference genome: [fasta](https://en.wikipedia.org/wiki/FASTA_format) format (`.fa` or `.fa.gz`)
2. methylation profile: [`CGmap`](https://bsbolt.readthedocs.io/en/latest/methylation_calling/) format generated by BSBolt (`.CGmap` or `.CGmap.gz`)
